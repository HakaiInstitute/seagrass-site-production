...
density_tendersnames_tofix$replace <- c("NA", "angeleen", "angeleen,carolyn,krystal", "derek", "gillian", "gillian", "kyle", "ondine", "other,zach", "zach") 
...
habitat_tendersnames_tofix$replace <- c("NA", "andrew", "ben") 
